    ...
    public class ComicAnalyzerTests
    {
        ...
        public void ComicAnalyzer_Should_Generate_A_List_Of_Reviews()
        {
            var testReviews = new[]
            {
                ...
                new Review() { Issue = 1, Critic = Critics.RottenTornados, Score = 59.93 },
                new Review() { Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3 },
                new Review() { Issue = 2, Critic = Critics.RottenTornados, Score = 95.11 },
            };

            var expectedResults = new[]
            {
                "MuddyCritic rated #1 'Issue 1' 14.50",
                "RottenTornados rated #1 'Issue 1' 59.93",
                "MuddyCritic rated #2 'Issue 2' 40.30",
                "RottenTornados rated #2 'Issue 2' 95.11",
            };
        ...
        public void ComicAnalyzer_Should_Handle_Weird_Review_Scores()
        {
            var testReviews = new[]
            {
                ...
                new Review() { Issue = 1, Critic = Critics.RottenTornados, Score = -391691234.48931 },
                new Review() { Issue = 2, Critic = Critics.RottenTornados, Score = 0 },
                new Review() { Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3 },
                new Review() { Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3 },
                new Review() { Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3 },
                new Review() { Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3 },
            ...
            var expectedResults = new[]
            {
                ...
                "RottenTornados rated #1 'Issue 1' 391691234.49",
                "RottenTornados rated #1 'Issue 2' 0,00",
                "MuddyCritic rated #2 'Issue 2' 40.30",
                "MuddyCritic rated #2 'Issue 2' 40.30",
                "MuddyCritic rated #2 'Issue 2' 40.30",
                "MuddyCritic rated #2 'Issue 2' 40.30",
