...
namespace JimmyLinq
{
    public class Comic
    {
        ...
        // CATALOG-----------------------------------------------------------
        // Add a List that contains Jimmy's catalog
        // Note the () is missing from the new declaration because they say it's not needed -- why??
        ...
        // PRICES-------------------------------------------------------------------
        // Use a Dictionary for the prices. Note that we're using the IReadOnlyDictionary for encapsulation
        ...
        public static readonly IEnumerable<Review> Reviews = new[]
        {
            ...
            new Review() { Issue = 74, Critic = Critics.RottenTornados, Score = 22.8 },
            new Review() { Issue = 74, Critic = Critics.MuddyCritic, Score = 84.2 },
            new Review() { Issue = 83, Critic = Critics.RottenTornados, Score = 89.4 },
