...
namespace Weapons
{
    class Program
    {
        // 1. Don't make any changes to the Main method. It will use the new SwordDamage and ArrowDamage
        // classes exactly like it did at the beginning of the chapter.
