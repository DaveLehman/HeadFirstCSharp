...
namespace BeehiveINotifyPropertyChanged
{
    class Queen:Bee,INotifyPropertyChanged
    {
        ...
        // implements INotifyPropertyChanged by declaring an event
        // Any class you use for data binding fires (or invokes) its PropertyChanged event to let WPF
        // know a property has changed
        ...
        {
            // Queen needs to fire its event -- what changed? name
